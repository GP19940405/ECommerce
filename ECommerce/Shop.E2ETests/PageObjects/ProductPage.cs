...
namespace Shop.E2ETests.PageObjects
{
    public class ProductPage
    {
        ...
        private readonly IWebElement whiteItem;
        ...
        public ProductPage(IWebDriver driver)
        {
            ...
            whiteItem = driver.FindElement(By.CssSelector("#color_8"));
        ...
        {
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementToBeClickable(whiteItem));
            whiteItem.Click();
        }
